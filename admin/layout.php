...
function renderPage(string $title, string $activeMenu, callable $callback): void
{
    ...
    $admin = function_exists('currentAdmin') ? currentAdmin() : [];
    $adminName = trim((string)($admin['full_name'] ?? $admin['display_name'] ?? $admin['username'] ?? 'مدير النظام'));
    if ($adminName === '') {
        $adminName = 'مدير النظام';
    }

    /*
     * أضف أي رابط جديد هنا مستقبلًا
     */
    $navItems = [
        'dashboard' => [
            'icon'  => 'bi-speedometer2',
            'label' => 'لوحة التحكم',
            'href'  => ADMIN_PATH . '/dashboard.php',
        ],
        'beneficiaries' => [
            'icon'  => 'bi-people-fill',
            'label' => 'المستفيدون',
            'href'  => ADMIN_PATH . '/beneficiaries.php',
        ],
        'distributions' => [
            'icon'  => 'bi-box-seam-fill',
            'label' => 'التوزيعات',
            'href'  => ADMIN_PATH . '/distributions.php',
        ],
        'import' => [
            'icon'  => 'bi-upload',
            'label' => 'استيراد البيانات',
            'href'  => ADMIN_PATH . '/import.php',
        ],

        /* الجديد */
        'ayni' => [
            'icon'  => 'bi-bag-heart-fill',
            'label' => 'الواردات العينية',
            'href'  => '/zaka/ayni/index.php',
        ],
        ...
        'finance' => [
            'icon'  => 'bi-cash-coin',
            'label' => 'المالية',
            'href'  => '/zaka/finance/index.php',
        ],

        'archive' => [
            'icon'  => 'bi-archive-fill',
            'label' => 'أرشيف التوزيعات',
            'href'  => ADMIN_PATH . '/distribution_items_archive.php',
        ],
        'settings' => [
            'icon'  => 'bi-gear-fill',
            'label' => 'الإعدادات',
            'href'  => ADMIN_PATH . '/settings.php',
        ],
    ];
    ?>
<!DOCTYPE html>
